...
import { Mail, Lock, User, ArrowRight, Shield, AlertCircle, Loader2 } from 'lucide-react';
...
export default function Register() {
  ...
  return (
    <div>
      ...
      {error && (
        <div className="mb-4 flex items-center gap-2.5 rounded-xl bg-rose-500/10 border border-rose-500/20 px-4 py-3">
        ...
        <div>
          ...
          <div className="relative group">
            ...
            <input
              ...
              className="block w-full rounded-xl bg-white/[0.03] border border-white/[0.06] text-slate-100 pl-10 pr-3 py-2.5 text-sm placeholder-slate-600 focus:border-indigo-500/30 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 transition-all"
          ...
          {password && (
            <div className="mt-2 animate-fade-in">
                ...
                {[1, 2, 3, 4].map((i) => (
                  <div
                    ...
                    className={`h-1 rounded-full flex-1 transition-all duration-300 ${
                      i <= strength ? strengthColors[strength] : 'bg-white/[0.04]'
                    }`}
                  />
                ))}
              </div>
              <div className="flex items-center gap-1.5">
                ...
                <span className={`text-[10px] font-semibold ${strengthTextColors[strength] || 'text-slate-600'}`}>
