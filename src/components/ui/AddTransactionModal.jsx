...
import { X, Plus, DollarSign, Calendar, Tag, FileText, CheckCircle2, AlertCircle } from 'lucide-react';
        ...
        >
          ...
          <div className="flex items-center justify-between p-5 border-b border-white/[0.06]">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-sm font-bold text-slate-100">Add Transaction</h3>
                <p className="text-[10px] text-slate-600">Record a new transaction</p>
              </div>
            </div>
            <button
              type="button"
