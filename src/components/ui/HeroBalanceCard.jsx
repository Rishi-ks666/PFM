...
const balanceHistory = [
  { month: 'Apr', value: 58200 },
  { month: 'May', value: 61400 },
  { month: 'Jun', value: 59800 },
  { month: 'Jul', value: 64100 },
  { month: 'Aug', value: 67300 },
  { month: 'Sep', value: 70900 },
  { month: 'Oct', value: 73630 },
];
...
export default function HeroBalanceCard() {
  const { totalNetWorth } = useFinanceStats();
  const { formatCurrency } = useFinance();

  // Compute dynamic percentage change from balance history
