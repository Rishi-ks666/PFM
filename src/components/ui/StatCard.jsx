...
// Random sparkline data generator — only used as last resort fallback
const FLAT_SPARKLINE = Array(12).fill(0);

export default function StatCard({ title, amount, trend, isPositive, icon: Icon, delay = 0, sparklineData }) {
  const sparkData = useMemo(() => sparklineData || FLAT_SPARKLINE, [sparklineData]);
